...
public final class Constants {
    ...
    public static final String GOOGLE_SEARCH = "http://m.max.58corp.com";
    public static final String MAX_58CORP_PAGE = "http://m.max.58corp.com";
    ...
    public static final String STARTPAGE_MOBILE_SEARCH = "http://m.max.58corp.com";
    public static final String STARTPAGE_SEARCH = "http://m.max.58corp.com";
